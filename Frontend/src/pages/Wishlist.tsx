...
import {
  ...
  Star, Truck, Sparkles, CheckCircle, Bell
} from "lucide-react";
                  ...
                  <div className="p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4">
                          {/* Product Image — clicks through to detail */}
                          <Link
                            to={`/products/${item.id}`}
                            className="relative w-24 h-24 bg-gray-100 rounded-xl overflow-hidden flex-shrink-0 hover:opacity-90 transition-opacity"
                          >
                            <img
                              src={item.image}
                              alt={item.name}
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                {/* Name clicks through to detail */}
                                <Link
                                  to={`/products/${item.id}`}
                                  className="font-bold text-gray-900 mb-1 hover:text-blue-600 transition-colors line-clamp-2"
                                >
                                  {item.name}
                                </Link>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                                <div className="text-xs text-gray-500">Added to wishlist</div>
