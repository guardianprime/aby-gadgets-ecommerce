...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Go back to wherever the user came from (e.g. /checkout)
  ...
  return (
    <AuthLayout
      ...
      subtitle="Your trusted store for authentic gadgets. Sign in to track your orders, get updates, and shop faster next time."
    >
      <div>
        <button
          onClick={() => navigate(-1)}
        ...
        {/* Show where the user will land after login */}
        {redirectTo !== "/" && (
          <p className="text-sm text-blue-600 mb-6">
            You'll be taken back to your previous page after signing in.
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-sm text-gray-600">
            ...
            <Link
              // Pass the same redirect along to signup so the flow is preserved
