...
import { ArrowLeft, Heart, Star, Minus, Plus, ChevronLeft, ChevronRight, ShieldCheck, Truck, Eye } from "lucide-react";
...
const ProductDetails = () => {
  ...
  const similarProducts = products.filter(p => p.id !== product.id).slice(0, 5);
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "12/09/2025",
      comment: "I was honestly scared at first, but the phone came exactly as described. Battery health was correct, no issues at all. Very neat and smooth. AbyGadgets really delivered."
    },
    {
      id: 2,
      name: "Blessing O.",
      rating: 5,
      date: "30/12/2025",
      comment: "Camera quality is mad. Phone looks almost new and delivery was fast. I also liked that I could inspect before finalizing payment. Definitely buying again."
    },
    {
      id: 3,
      name: "Ibrahim S.",
      rating: 4,
      date: "17/10/2025",
      comment: "Phone performance is solid and battery lasts well. Slight sign of use but nothing serious. Overall very good value for the price."
    },
    {
      id: 4,
      name: "Esther K.",
      rating: 5,
      date: "9/06/2025",
      comment: "Everything was smooth from order to delivery. The phone is original, no replaced parts, and works perfectly. Customer support was also helpful."
    }
  ];

  // Exact key highlights text from your image
  const keyHighlights = [
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-3">
        <Link to="/products" className="inline-flex items-center gap-1 text-sm text-gray-600 hover:text-gray-900 transition-colors">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="relative">
            {/* Main Image Container - Exactly like image with lots of padding */}
            <div className="relative aspect-square bg-white rounded-lg border border-gray-200 mb-4 overflow-hidden">
              ...
              {/* Navigation Arrows */}
              <button 
                className="absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-300 hover:bg-gray-50 transition-colors"
                onClick={() => setSelectedImage(prev => Math.max(0, prev - 1))}
              >
                <ChevronLeft className="w-4 h-4 text-gray-700" />
              </button>
              <button 
                className="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center shadow-md hover:bg-purple-700 transition-colors"
            ...
            {/* Thumbnail Gallery - Exactly 4 thumbnails */}
          ...
          {/* Right Column - Product Info - Exact layout from image */}
          <div className="pt-2">
            {/* Product Title - Small as shown in image */}
            ...
            <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              {product.description || "(UK Used), 256GB, 89% battery health, very neat condition, all parts original and fully functional."}
            </p>

            {/* Trust Badges - Exactly like image with 2 badges */}
            ...
            {/* Quantity Selector - Simple and clean */}
            <div className="mb-8">
        ...
        {/* Key Highlights Section - EXACTLY like image - FULL WIDTH */}
        ...
        {/* Reviews Section - EXACTLY like image - FULL WIDTH */}
        <div className="mt-16 pt-12 border-t border-gray-200">
          ...
          <div className="space-y-0">
            {reviews.map((review, index) => (
              <div key={review.id} className="border-b border-gray-200 last:border-b-0">
                <div className="py-6">
                  {/* Name - Bold and on its own line */}
                  <h4 className="font-bold text-gray-900 mb-2">{review.name}</h4>
                  
                  {/* Date and Stars - On same line */}
                ...
                {/* Divider - Only show if not the last review */}
        ...
        {/* Similar Products Section - Exactly like image */}
        ...
        {/* Trust Badges Section - Exactly like image footer section */}
        <div className="mt-16 pt-12 border-t-2 border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="text-center">
              <ShieldCheck className="w-8 h-8 text-green-600 mx-auto mb-2" />
              <h3 className="font-semibold text-gray-900 mb-1">Guaranteed Originality</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Inspect Before You Buy</h3>
